...
$message .= "http://sandy1709.host20.uk/sharethecar/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'carsharing@sandy1709.host20.uk')){
