...
$message .= "http://sandy1709.host20.uk/sharethecar/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for you Car sharing website', $message, 'From:'.'carsharing@sandy1709.host20.uk')){
